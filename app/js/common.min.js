...
;// CONCATENATED MODULE: ./app/js/parts/lp.js
document.addEventListener('DOMContentLoaded', function () {
  var merchiImgLonggrid = document.querySelector('.merch__section-imglonggridwrap');
  var vplayerSC = document.querySelector('.vplayer__section-container');
  window.addEventListener('scroll', function () {
    var scrollPosition = window.pageYOffset;
    merchiImgLonggrid.style.left = "-".concat(scrollPosition, "px");
    vplayerSC.style.right = "-".concat(scrollPosition, "px");
  });
});
